$(function(){
  ...
  $('#submenu_btn,.nav>ul>li:first-child').click(function(){
    ...
    if(submenuBottom=='80px'){
      close_sub_menu();
      $('.submenu').css('bottom','-'+submenuHeight+'px').css('background-color','#fff');
    }else{
      $('.submenu').css('bottom','100%').css('background-color','transparent');
    }
  }); 
  ...
  $('#clock_btn').click(function(){
    ...
    if(subwatcheBottom=='80px'){
      ...
      $('.subwatche').css('bottom','100%').css('background-color','transparent');
    }
  });
  function fsubwatcheBottom(){
    var subwatcheHeight=$('.subwatche').height();
    $('.subwatche').css('bottom','-'+subwatcheHeight+'px').css('background-color','#fff');
  }
  ...
  $('#search_btn').click(function(){
    ...
    if(tmp=='none'){
      ...
      $('.banner').css('padding-top',searchFormHeight);
    }else if(tmp=='flex'){
